...
describe('WS6 renderer boundary', () => {
  ...
  it('rejects forbidden imports at arbitrary renderer nesting depth', async () => {
    const cases = [
      ...
      ['../../../../domain/secret-loader', 'configuration or secret-loading modules'],
      ['../../../../domain/api-key', 'configuration or secret-loading modules'],
      ['../../../../domain/apikey', 'configuration or secret-loading modules'],
      ['../../../../domain/env', 'configuration or secret-loading modules'],
      ['../../../../domain/env-loader', 'configuration or secret-loading modules'],
